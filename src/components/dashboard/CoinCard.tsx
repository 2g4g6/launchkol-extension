      ...
      >
        ...
        <div className="flex items-stretch">
          ...
          <motion.button
            ...
            className="flex items-center justify-center gap-2 px-8 py-4 self-start flex-shrink-0 rounded-tr-lg border-l border-kol-border/40 bg-kol-blue/25 hover:bg-kol-blue/40 text-white text-sm font-semibold transition-all duration-300"
            whileTap={{ scale: 0.98 }}
          >
            <span>Manage</span>
