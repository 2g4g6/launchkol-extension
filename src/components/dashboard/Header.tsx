...
function SearchInput({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="relative flex items-center gap-2 px-3 py-1.5 rounded-lg bg-kol-surface/50 border border-[#333333] hover:border-kol-blue/30 hover:bg-kol-surface/70 transition-colors cursor-pointer group min-w-[120px]"
    >
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className="relative flex items-center gap-2 px-3 py-1.5 rounded-lg bg-kol-surface/50 border border-[#333333] hover:border-kol-blue/30 transition-all cursor-pointer group"
