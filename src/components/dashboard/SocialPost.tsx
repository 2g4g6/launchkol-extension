        ...
        <div className="flex items-stretch border-b border-kol-border/40 min-h-[60px]">
          ...
          {onDeploy && (
            <motion.button
              ...
              className="flex items-center justify-center gap-2 px-12 py-4 border-l border-kol-border/40 bg-kol-blue/25 hover:bg-kol-blue/40 text-white text-sm font-semibold transition-all duration-300"
              whileTap={{ scale: 0.98 }}
            >
              <span>Launch</span>
