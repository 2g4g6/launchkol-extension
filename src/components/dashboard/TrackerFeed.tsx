...
const MOCK_POSTS: SocialPostData[] = [
  ...
  },
  {
    ...
    content: 'Top wallet just moved 500 SOL to new address. Watching for deployment.',
  ...
  },
  {
    ...
    content: 'Interesting new project launching soon. Team looks solid, watching closely.',
